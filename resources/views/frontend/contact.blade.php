...
@section('content')
<section class="parallax-container overlay-1" data-parallax-img="{{asset('assets/images/contactcover.webp')}}">
          ...
          <div class="row row-50">
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-classic">
                ...
                <div class="box-icon-caption">
                  <h4><a href="tel:#">+880 1710-770 590</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-classic">
                ...
                <div class="box-icon-caption">
                  <h4><a href="#">Dayarampur, Natore</a></h4>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-classic">
                ...
                <div class="box-icon-caption">
                  <h4><a href="mailto:#">nosinjesin90@gmail.com</a></h4>
        ...
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-md-9 col-lg-7">
              <h3>Get in Touch</h3>
              <!-- RD Mailform-->
              <form data-form-output="form-output-global" data-form-type="contact" method="post" action="{{ route('contact.send') }}">
                @csrf
                <div class="form-wrap">
